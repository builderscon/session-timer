...
/***/ function(module, exports, __webpack_require__) {
	...
	var se = 'http://jsrun.it/assets/f/S/f/q/fSfqC.mp3';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timer = __webpack_require__(170);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleChangeLimit(limit) {
	      this.setState({
	        limit: limit
	      });
	    }
	    ...
	    key: 'handleTick',
	    value: function handleTick(past) {
	      var restTimeClassName = this.getRestTimeClass(past / this.state.limit);

	      this.setState({
	        restTimeClassName: restTimeClassName
	      });
	    }
	  }, {
	    key: 'handleLimit',
	    ...
	    key: 'getRestTimeClass',
	    value: function getRestTimeClass(rest) {
	      if (rest >= 0.92) {
	        // ex. 残5分 / 60分セッション
	        return 'danger';
	      } else if (rest >= 0.83) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = function (_Component) {
	  ...
	  _createClass(Timer, [{
	    key: 'render',
	    value: function render() {
	      var rest = this.getRestTime();
	      var humanizeTime = this.humanizeTime(this.props.limit - this.state.past);
	      var style = {
	    ...
	    key: 'humanizeTime',
	    value: function humanizeTime(rest) {
	    ...
	    key: 'tick',
	    value: function tick() {
	      var past = (new Date() - this.state.startAt) / 1000;
	      this.setState({
	        past: past
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SE = function (_Component) {
	  ...
	  function SE() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SE).apply(this, arguments));
	  }
	  ...
	  _createClass(SE, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "audio",
	        { preload: "auto", ref: "se" },
	        _react2.default.createElement("source", { src: this.props.sound, type: "audio/mp3" })
	      );
	    }
	  }, {
	    key: "play",
